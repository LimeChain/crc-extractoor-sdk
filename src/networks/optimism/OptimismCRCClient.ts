import { BN, bufferToHex, bufferToInt, intToHex, keccak, setLengthLeft, toBuffer, unpadHexString } from "ethereumjs-util";
...
import { EthereumCRCClient } from "../ethereum/EthereumCRCClient";
...
export class OptimismCRCClient {

    optimism: EthereumCRCClient
    ethereum: EthereumCRCClient

    constructor(optimismRpcUrl: string, ethereumRpcUrl) {
        this.optimism = new EthereumCRCClient(optimismRpcUrl);
        this.ethereum = new EthereumCRCClient(ethereumRpcUrl)
    }
